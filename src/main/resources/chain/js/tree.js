...
$(".chain").each(function () {
    var that = $(this);
    $.get('/callChain/' + that.attr("id"), function (data) {
        f(data);
...
<!--树形结构-->
$(function () {
    $('.chain li:has(ul)').addClass('parent_li').find(' > span').attr('title', 'Collapse this branch');
    $('.chain li.parent_li > span').on('click', function (e) {
